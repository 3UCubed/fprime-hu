...
namespace Svc {
  ...
  namespace {
    ...
    union BuffUnion {
      BYTE comDataInPortSize[Drv::InputByteStreamSendPort::SERIALIZED_SIZE];
      BYTE drvConnectedPortSize[Drv::InputByteStreamReadyPort::SERIALIZED_SIZE];
      BYTE drvDataInPortSize[Drv::InputByteStreamRecvPort::SERIALIZED_SIZE];
    };
