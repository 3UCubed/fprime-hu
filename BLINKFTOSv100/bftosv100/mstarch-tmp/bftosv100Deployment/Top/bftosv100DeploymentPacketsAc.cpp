...
#include <bftosv100Deployment/Top/bftosv100DeploymentPacketsAc.hpp>
...
namespace bftosv100Deployment {
  ...
  static const Svc::TlmPacketizerChannelEntry CDHList[] = {
      ...
      {2560, 4}, // fileUplink.FilesReceived
      {2561, 4}, // fileUplink.PacketsReceived
      {17408, 4}, // bufferManager.TotalBuffs
      {17409, 4}, // bufferManager.CurrBuffs
      {17410, 4}, // bufferManager.HiBuffs
      {2048, 4}, // fileDownlink.FilesSent
      {2049, 4}, // fileDownlink.PacketsSent
      {2304, 4}, // fileManager.CommandsExecuted
  };
  ...
  static const Svc::TlmPacketizerChannelEntry CDHErrorsList[] = {
      ...
      {2562, 4}, // fileUplink.Warnings
      {2050, 4}, // fileDownlink.Warnings
      {8192, 4}, // health.PingLateWarnings
      {2305, 4}, // fileManager.Errors
      {17411, 4}, // bufferManager.NoBuffs
      {17412, 4}, // bufferManager.EmptyBuffs
      {2305, 4}, // fileManager.Errors
  };
  ...
  static const Svc::TlmPacketizerChannelEntry CommsList[] = {
      {1792, 8}, // comQueue.comQueueDepth
      {1793, 4}, // comQueue.buffQueueDepth
  };

  static const Svc::TlmPacketizerPacket Comms = { CommsList, 4, 1, FW_NUM_ARRAY_ELEMENTS(CommsList) };
  ...
  const Svc::TlmPacketizerPacketList bftosv100DeploymentPacketsPkts = {
      {
         &CDH,
         &CDHErrors,
         &DriveTlm,
  ...
  const Svc::TlmPacketizerPacket bftosv100DeploymentPacketsIgnore = { ignoreList, 0, 0, FW_NUM_ARRAY_ELEMENTS(ignoreList) };

} // end namespace bftosv100Deployment
