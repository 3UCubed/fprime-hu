...
SET(STM32_BSP_PATH "${CMAKE_CURRENT_LIST_DIR}/../../freertosstm32/STM32" CACHE PATH "Path to STM32 BSP")
set(MCU_LINKER_SCRIPT ${STM32_BSP_PATH}/STM32H753XIHX_FLASH.ld)
...
set(CMAKE_C_FLAGS
  "${CMAKE_C_FLAGS} ${COMPILER_COMMON_FLAGS} \
    -std=c99"
    )  

set(CMAKE_CXX_FLAGS
  "${CMAKE_CXX_FLAGS} ${COMPILER_COMMON_FLAGS} \
    -std=c++14 \
    -fno-rtti \
    -fno-exceptions \
