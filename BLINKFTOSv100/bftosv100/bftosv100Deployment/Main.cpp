...
static void signalHandler(int signum) {
    bftosv100Deployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    bftosv100Deployment::setupTopology(inputs);
    bftosv100Deployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    bftosv100Deployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
