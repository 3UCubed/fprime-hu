// ======================================================================
// \title  bftosv100DeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef BFTOSV100DEPLOYMENT_BFTOSV100DEPLOYMENTTOPOLOGY_HPP
#define BFTOSV100DEPLOYMENT_BFTOSV100DEPLOYMENTTOPOLOGY_HPP
// Included for access to bftosv100Deployment::TopologyState and bftosv100Deployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <bftosv100Deployment/Top/bftosv100DeploymentTopologyDefs.hpp>

// Remove unnecessary bftosv100Deployment:: qualifications
using namespace bftosv100Deployment;
 ...
 * bftosv100Deployment::TopologyState see: bftosv100DeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type bftosv100Deployment::TopologyState see: bftosv100DeploymentTopologyDefs.hpp.
 *
