// ======================================================================
// \title  bftosv100DeploymentTopology.cpp
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(bftosv100DeploymentPacketsPkts, bftosv100DeploymentPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name bftosv100Deployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        bftosv100Deployment::blockDrv.callIsr();
